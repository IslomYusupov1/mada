...
@Component({
  selector: 'app-auto-model-info-right',
  templateUrl: './auto-model-info-right.component.html',
  styleUrls: ['./auto-model-info-right.component.scss']
})
export class AutoModelInfoRightComponent implements OnInit, OnChanges {
  ...
  ngOnInit(): void {
    if (this.modelId) {
      this.reqData.modelId = this.modelId
      this.getData()
    }
  }
  ...
  addModel() {
    ...
    console.log('=================================')
    this.myAutoService.editModelSimilarName({
