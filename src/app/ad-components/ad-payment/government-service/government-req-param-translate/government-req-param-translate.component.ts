...
@Component({
  selector: 'app-government-req-param-translate',
  templateUrl: './government-req-param-translate.component.html',
  styles: [`
    .mat-form-field {
      width: 100%;
    }
...
export class GovernmentReqParamTranslateComponent implements OnInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<GovernmentReqParamTranslateComponent>,
  ...
  saveTranslate() {
    if (this.titleTranslationForm.valid) {
      this.govService.stateReqParamTranslate({
